...
public class GameManager : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        Loss = PlayerPrefs.GetInt("Player Loss");
            ...
            case GameState.EndGame:
                {
                    ...
                    PlayerPrefs.SetInt("Player Loss", Loss);
                    UiInGame.SetActive(false);
                    TxtScoreGameOver.text = "Win: " + Score + " \n" + "Loss: " + Loss ;
    ...
    public void GetScore(int NewScore, int NewLoss)
    {
        Score += NewScore;
        Loss += NewLoss;
        TxtScore.text = "Win: " + Score + "  Loss: " + Loss;
